...
const enUS: Record<string, string> = {
  ...
  "resourceManager.storage.category.exports": "Exports",
  ...
  "resourceManager.storage.categoryDescription.exports": "Exported log bundles.",
  ...
  "settings.usage.apiKeyTitle": "API key plan quota",
  "settings.usage.apiKeyDescription":
    "Only queries the configured Coding Plan API key; no official account login is required.",
  "settings.usage.apiKeyLabel": "Coding Plan API key",
  "settings.usage.apiKeyConfigured": "Configured",
  "settings.usage.apiKeyNoPlan": "No active plan",
  "settings.usage.planStatus": "Plan status",
  "settings.usage.remainingRatio": "Remaining",
  "settings.usage.quotaLevel": "Quota level",
  "settings.usage.updatedAt": "Updated",
  "settings.usage.notAvailable": "N/A",
  ...
  "settings.modelProvider.presetDescription":
    "Built-in Z.ai and BigModel API Key / Coding Plan provider templates.",
  "settings.modelProvider.presetEmpty": "No built-in provider templates are available.",
