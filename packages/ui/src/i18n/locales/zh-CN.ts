...
const zhCN: Record<string, string> = {
  ...
  "resourceManager.storage.category.exports": "导出",
  ...
  "settings.modelProvider.presetDescription":
    "内置 Z.ai 与 BigModel API Key / Coding Plan 供应商模板。",
  "settings.modelProvider.presetEmpty": "暂无可用的内置供应商模板。",
  ...
  "settings.usage.apiKeyTitle": "API Key 套餐额度",
  "settings.usage.apiKeyDescription": "仅查询已配置的 Coding Plan API Key，不需要官方账号登录。",
  "settings.usage.apiKeyLabel": "Coding Plan API Key",
  "settings.usage.apiKeyConfigured": "已配置",
  "settings.usage.apiKeyNoPlan": "暂无有效套餐",
  "settings.usage.planStatus": "套餐状态",
  "settings.usage.remainingRatio": "剩余比例",
  "settings.usage.quotaLevel": "额度等级",
  "settings.usage.updatedAt": "更新时间",
  "settings.usage.notAvailable": "暂无",
