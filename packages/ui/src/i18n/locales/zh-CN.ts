...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 NCode 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 NCode 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 NCode 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 NCode",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 NCode。",
  ...
  "startup.global.help":
    "准备完成后将自动进入 NCode。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 NCode 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 NCode",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 NCode 后重试",
  ...
  "login.title": "欢迎来到 NCode",
  "login.description": "连接账号，开始使用 NCode",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 NCode？",
  ...
  "titleBar.menu.help.about": "关于 NCode",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 NCode 即可继续使用。",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 NCode 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 NCode 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 NCode 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 NCode 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "NCode 总占用",
  ...
  "resourceManager.storage.diskUsage": "NCode 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 NCode 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "NCode 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 NCode。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。NCode 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 NCode 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 ZCode Agent 不支持 OAuth 状态刷新。请升级或重启 NCode，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 NCode。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 NCode",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 NCode 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 NCode 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。NCode 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。NCode 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 NCode 即可继续编码。",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 NCode。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。NCode 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 NCode",
  ...
  "settings.plugins.store.subtitle": "用插件为 NCode 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 NCode，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。NCode 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 NCode",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 NCode。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。NCode 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 NCode",
  ...
  "onboarding.dialog.title": "欢迎使用 NCode",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 NCode",
  "onboarding.welcome.start": "开始使用 NCode",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 NCode 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，NCode 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 NCode 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 NCode 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 NCode 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 NCode 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 NCode 修订后另存一版。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "NCode 报错信息",
  ...
  "offPeak.keepAwakeBanner": "NCode 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 NCode 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "NCode 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "NCode 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 NCode",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 NCode 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，NCode 会针对该会话精确验证电脑控制工具。",
